...
import { ResendOptions } from './subscribe/Resends';
import { NetworkNodeStub } from './NetworkNodeFacade';
import { UpdateEncryptionKeyOptions } from './encryption/GroupKeyStore';
import { StorageNodeMetadata } from './registry/StorageNodeRegistry';
import { StreamDefinition } from './types';
import { Subscription } from './subscribe/Subscription';
import { StreamrClientEvents } from './events';
 ...
 * @category Important
 */
export declare class StreamrClient {
    static readonly generateEthereumAccount: () => {
        address: string;
        privateKey: string;
    };
    readonly id: string;
    ...
    private readonly proxyPublishSubscribe;
    ...
    constructor(config?: StreamrClientConfig, persistence?: Persistence<string, string>, 
    /** @internal */
    parentContainer?: import("tsyringe").DependencyContainer);
    /**
     ...
     */
    publish(streamDefinition: StreamDefinition, content: unknown, metadata?: PublishMetadata): Promise<Message>;
    /**
     ...
     */
    addEncryptionKey(key: GroupKey, streamIdOrPath: string): Promise<void>;
    /**
     ...
     */
    subscribe(options: StreamDefinition & {
        resend?: ResendOptions;
    }, onMessage?: MessageListener): Promise<Subscription>;
    /**
     ...
     */
    resend(streamDefinition: StreamDefinition, options: ResendOptions, onMessage?: MessageListener): Promise<MessageStream>;
    /**
     ...
     * associated metadata
     */
    createStream(propsOrStreamIdOrPath: Partial<StreamMetadata> & {
        id: string;
     ...
     */
    updateStream(props: Partial<StreamMetadata> & {
        id: string;
    }): Promise<Stream>;
    /**
     * Deletes a stream.
     ...
     */
    addStreamToStorageNode(streamIdOrPath: string, storageNodeAddress: string): Promise<void>;
    /**
     * Unassigns a stream from a storage node.
     */
    removeStreamFromStorageNode(streamIdOrPath: string, storageNodeAddress: string): Promise<void>;
    /**
     * Checks whether a stream is assigned to a storage node.
     */
    isStoredStream(streamIdOrPath: string, storageNodeAddress: string): Promise<boolean>;
    /**
